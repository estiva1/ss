...
const headingGuideSteps = ["Authorize Marketplace", "Add Cost", "Choose Strategy"];
...
const Guide = () => {
  ...
  const [aiProfileSelectButton, setaAiProfileSelectButton] = useState(null);
  const handleClick = (buttonId) => {
    setaAiProfileSelectButton(buttonId);
  };
